 ...
 * @Company: HOPE
 * @Author: RunningCode
 * @Date: 2023-03-23 17:03:41
 * @LastEditors: RunningCode
 * @LastEditTime: 2023-04-28 15:19:37
 * @Description: 
 * @Email: 547387405@qq.cn
 * @FilePath: \lvgl\examples\widgets\bar\lv_example_bar_6.c
 */
...
void lv_example_bar_6(void)
{
  ...
  //  lv_obj_add_event_cb(bar, event_cb, LV_EVENT_VALUE_CHANGED, NULL);
