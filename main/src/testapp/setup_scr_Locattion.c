 ...
 * @LastEditors  : MCD
 * @LastEditTime : 2024-03-05 17:02:07
...
static void location_outside_event_cb(lv_event_t *e)
{
    ...
    {
        lv_obj_del(obj);
        lv_obj_remove_event_cb(lv_layer_top(),location_outside_event_cb);
...
void lv_setting_location_select(lv_ui *ui)
{
    ...
    lv_obj_add_event_cb(lv_layer_top(), location_outside_event_cb, LV_EVENT_CLICKED, (void *)ui_Panel1); 
