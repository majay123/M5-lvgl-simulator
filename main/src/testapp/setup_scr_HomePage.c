...
//     {.dev_st = true, .dev_online = true, .dev_type = 3, .dev_name = "情景十八个灯", .dev_id = 22},
...
//     {.dev_st = true, .dev_online = true, .dev_type = 3, .dev_name = "灯光全开", .dev_id = 27},
...
// {
//     // main page init
//     ui->MainPage = lv_tabview_add_tab(ui->tabview, "111");
...
// {
//     ui->DevicePage = lv_tabview_add_tab(ui->tabview, "222");
